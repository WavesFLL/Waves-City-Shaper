...
def Crane(DriveBase,Arm,CSL,CSR,BMotSens,CMotSens): #The second program, finishes crane
    ...
    #25
    WSCUtil.Smooth(DriveBase, BMotSens, steerings=20,speedie=30,revolutions=1.25) #Drives toward black line
    ...
    #DriveBase.on_for_rotations(steering=-50,speed=30,rotations=0.75)
    WSCUtil.Smooth(DriveBase,CMotSens,steerings=-50,speedie=35,revolutions=0.75)
